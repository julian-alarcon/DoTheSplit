...
// Store is the top-level persistence dependency injected into cmd/server. It
// owns the connection(s), exposes every repository, and begins transactions.
// One concrete Store exists per engine (postgres, sqlite).
