// Activity feed Load-more island. Fetches the next page of activity rows as an
// HTML fragment from /groups/{id}/activity-fragment?cursor=... and appends the
// rendered <li> rows into the existing list. Updates the button's data-cursor
// in place; removes it when the server returns no next_cursor.
